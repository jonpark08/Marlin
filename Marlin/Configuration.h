...
#define STRING_CONFIG_H_AUTHOR "(JonPark08, KP3S config)" // Who made the changes.
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 160, 160, 800, 406.5 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 27, -1, -2.7 }
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { (X_MIN_POS + 10), (Y_MIN_POIS + 10), 10 }
...
#define NEOPIXEL_LED
  ...
  #define NEOPIXEL_PIXELS              11 // Number of LEDs in the strip. (Longest strip when NEOPIXEL2_SEPARATE is disabled.)
